...
st.markdown(
    "This project leverages the power of Python's data science ecosystem, including NumPy, Pandas, Plotly, and Scikit-learn, to analyze the Airbnb market in Amsterdam.  By uncovering insights into pricing trends, based on amenities, accomodates, and if it's instantly bookable. The project delivers a user-friendly platform for exploring the dataset and predicting Airbnb listing prices."
)
